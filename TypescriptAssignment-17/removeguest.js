"use strict";
let guest = ['Sir Ameen Alam', 'Sir Zia Khan', 'Sir Daniyal Nagori', 'Kamran Khan Tessori', 'Miss Hina Naseer', 'Sir M.Qasim'];
console.log("I have no more place to invite all of them, I can just invite 2 person.");
